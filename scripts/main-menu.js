        ...
        new Btn('Mike Lockhart').addClass('skin-main_menu')
            ...
            .append(new Btn('iStorage').addClass('skin-cloud')
                    ...
                    .append(new Btn('Keybase').addClass('skin-keybase')
                            .append(new Btn('bin').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/bin/')))
                            .append(new Btn('fun').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/fun/')))
                            .append(new Btn('hax').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/hax/')))
                            .append(new Btn('key').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/key/')))
                            .append(new Btn('pix').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/pix/')))
                            .append(new Btn('vid').addClass('skin-keybase').on('click', linkEvent('https://keybase.pub/sinewalker/vid/')))
                           )
