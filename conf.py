...
#   Created:    2014-08-21
#   Language:   Python
#   Time-stamp: <2015-11-06 11:47:13 mjl>
#   Platform:   (Nikola 7.1 configuration file)
#   OS:         *nix
#   Author:     [MJL] Michael J. Lockhart (mlockhart@squiz.net)
# 
#   Rights:     Copyright © 2014-2015 Michael James Lockhart, B.App.Comp(HONS)
# 
#   PURPOSE:    Nikola configuration file for Milosophical Me web site
# 
#       This is the configuration of Nikola, edited to my liking.
# 
#   HISTORY
# 
#   MJL20140821 - Created
#   MJL20141029 - working org-mode posts. moved my notes to a post,
#                 still drafting/planning, but getting there
#   MJL20150123 - finally published, output to github pages repo
#   MJL20150126 - fix copyright and sidebar for blog
#   MJL20150130 - more fixes for copyright
#   MJL20150128 - moved archive to subdirectory of output site
#   MJL20150130 - comments. categories renamed to tags
#   MJL20150201 - Upgraded to Nikola 7.3 for indexing features
#                 (tags+categories)
#   MJL20150327 - Added Markdown as a Format
#   MJL20151030 - For GitHub: go straight to my posts.
...
BLOG_AUTHOR = "Mike Lockhart"  # (translatable)
...
BLOG_EMAIL = "sinewalker@gmail.com"
BLOG_DESCRIPTION = "A geek's notebook"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'Home', 'icon-compass'),
        ('/archive/archive.html', 'Archive', 'icon-folder-open-alt'),
        ('/tags/index.html', 'Tags', 'icon-tags'),
        ('/pg/index.html', 'Codex', 'icon-book'),
#        ('/pixels/index.html', 'Pixels', 'icon-picture'),
        ('/rss.xml', 'RSS', 'icon-rss'),
        ('https://plus.google.com/+MichaelLockhart/posts', 'Microblog', 'icon-google-plus'),
        ('https://www.linkedin.com/in/mikelockhart', 'My LinkedIn profile', 'icon-linkedin'),
        ('https://bitbucket.com/sinewalker', 'My Bitbucket', 'icon-bitbucket'),
        ('https://github.com/sinewalker', 'My Github', 'icon-github'),
        ('http://stackoverflow.com/users/776953/mike', 'Stack Overflow', 'icon-stackexchange'),
    )
}
...
#REDIRECTIONS = [("about", "/pg/colophon.html")]
...
OUTPUT_FOLDER = 'sinewalker.github.io'
...
# (translatable)
CONTENT_FOOTER = '<hr/>Contents Copyright &copy; {license} 2005 &mdash; {date}         <a href="mailto:{email}">{author}</a>. Powered by <a href="http://getnikola.com" rel="nofollow">Nikola</a> with <a href="https://github.com/getnikola/nikola-themes/tree/master/v7/zen-ipython">Zen-IPython</a> theme.'
